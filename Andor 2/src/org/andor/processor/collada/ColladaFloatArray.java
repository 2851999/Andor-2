...
public class ColladaFloatArray {
	...
	/* The method used to return a set of values given the location, stride and whether the
	 * y coordinate should be inverted */
	public float[] getValues(int location, int stride, boolean invertY) {
