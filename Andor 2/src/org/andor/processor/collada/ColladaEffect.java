...
public class ColladaEffect {
	...
	/* The profile_COMMON instance */
	public ColladaProfileCommon profileCommon;
	...
	public void parse(Node parent) {
		...
		for (int a = 0; a < nodes.getLength(); a++) {
			...
			if (node.getNodeName().equals("profile_COMMON")) {
				this.profileCommon = new ColladaProfileCommon();
				this.profileCommon.parse(node);
			}
		}
	}
